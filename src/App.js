...
import PrivateRoute2 from "./routing/PrivateRoutingAddProducts1.jsx";
import ManageProducts from "./components/ManageUsersProducts.jsx";
...
import Myacount from './components/Myprofile'
//Auth//
...
import VirtualGallery from "./components/layout/VirtualGallery";
import AllArts from "./components/layout/AllArts";
import ArtsForAuctions from "./components/layout/ArtsForAuctions";
import MyAuctions from "./components/MyAuctions";
import AuctionEdit from "./components/AuctionEdit";
import PrivateRoutingAdminOwnCollections from "./routing/PrivateRoutingAdminOwnCollections";
import AdminOwnCollections from './components/AdminOwnCollections'
        ...
        <div className="App" id={theme}>
          <Router>
            ...
            <Switch>
              ...
              <Route exact path="/gallery" component={Room} />
              <PrivateRoute
                exact
              ...
              <PrivateRoute2
                exact
                path="/admin/add-atrsCollections"
              ...
              <PrivateRoutingAdminOwnCollections
                exact
                path="/admin-own/atrsCollections/:id"
                component={AdminOwnCollections}
              />
              ...
              <Route exact path="/virtual-tour" component={VirtualGallery} />
              
              <Route exact path="/arts" component={AllArts} />
              <Route exact path="/create-bid" component={ArtsForAuctions} />
              <Route exact path="/user/profle/:id" component={Myacount} />
              <Route exact path="/user/collections/:id" component={MyAuctions} />
              <Route exact path="/user/auction-edit/:id" component={AuctionEdit} />
